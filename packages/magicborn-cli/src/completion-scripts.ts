...
complete -c magicborn -f -n "__fish_use_subcommand" -a users -d "Vendor CLI (users)"
complete -c magicborn -f -n "__fish_use_subcommand" -a org -d "Vendor CLI (org)"
complete -c magicborn -f -n "__fish_use_subcommand" -a tenant -d "Vendor CLI (tenant)"
complete -c magicborn -f -n "__fish_use_subcommand" -a blog -d "Vendor CLI (blog)"
...
complete -c magicborn -f -n '__fish_seen_subcommand_from_path vendor' -a "add list users org tenant blog --id -i"
`;
