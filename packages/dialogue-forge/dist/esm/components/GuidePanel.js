...
===`),
                ...
                React.createElement("div", { className: "bg-[#12121a] p-4 rounded border border-[#2a2a3e]" },
                    React.createElement("pre", { className: "text-xs font-mono text-gray-300 whitespace-pre-wrap overflow-x-auto" }, `import { importFromYarn, exportToYarn } from '@portfolio/dialogue-forge';
