...
export function PlayerNodeV2({ data, selected }) {
    ...
    return (React.createElement("div", { className: `rounded-lg border-2 transition-all duration-300 ${selected ? 'border-[#8b5cf6] shadow-lg shadow-[#8b5cf6]/20' :
        ...
        React.createElement("div", { ref: headerRef, className: "px-3 py-1.5 border-b border-[#2a2a3e] bg-[#16162a] flex items-center gap-2 rounded-t-lg" },
            React.createElement(GitBranch, { size: 12, className: "text-purple-400" }),
            React.createElement("span", { className: "text-[10px] font-mono text-gray-500 truncate flex-1" }, node.id),
            React.createElement("span", { className: "text-[10px] text-gray-600" }, "PLAYER")),
        React.createElement("div", { className: "border-t border-[#2a2a3e]" }, choices.map((choice, idx) => {
            ...
            return (React.createElement("div", { key: choice.id, ref: el => {
                ...
                React.createElement("div", { className: "flex-1 min-w-0" },
                    React.createElement("span", { className: "truncate block bg-[#0d0d14] border border-[#2a2a3e] rounded px-2 py-1 text-gray-300" },
                        "\"",
