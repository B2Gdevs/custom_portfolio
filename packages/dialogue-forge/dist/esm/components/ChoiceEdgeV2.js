...
export function ChoiceEdgeV2({ id, sourceX, sourceY, sourcePosition, targetX, targetY, targetPosition, data, selected, }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        isBackEdge && (React.createElement("g", { transform: `translate(${labelX - 10}, ${labelY - 10})` },
            React.createElement("circle", { cx: "10", cy: "10", r: "12", fill: "#1a1a2e", stroke: color, strokeWidth: "2" }),
            React.createElement("text", { x: "10", y: "14", textAnchor: "middle", fontSize: "12", fill: color }, "\u21BA"))),
        ...
        React.createElement("defs", null,
            React.createElement("marker", { id: `react-flow__arrowclosed-${color.replace('#', '')}`, markerWidth: "12.5", markerHeight: "12.5", viewBox: "-10 -10 20 20", markerUnits: "strokeWidth", orient: "auto", refX: "0", refY: "0" },
                React.createElement("polyline", { stroke: color, strokeLinecap: "round", strokeLinejoin: "round", fill: color, points: "-5,-4 0,0 -5,4 -5,-4" })))));
}
