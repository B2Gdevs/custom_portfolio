...
export function ConditionalNodeV2({ data, selected }) {
    ...
    return (React.createElement("div", { className: `rounded-lg border-2 transition-all duration-300 ${selected ? 'border-blue-500 shadow-lg shadow-blue-500/20' :
        ...
        React.createElement("div", { ref: headerRef, className: "px-3 py-1.5 border-b border-[#2a2a3e] bg-[#12121a] flex items-center gap-2 rounded-t-lg" },
            React.createElement(GitBranch, { size: 12, className: "text-blue-400" }),
            React.createElement("span", { className: "text-[10px] font-mono text-gray-500 truncate flex-1" }, node.id),
            React.createElement("span", { className: "text-[10px] text-blue-400" }, "IF/ELSE")),
        React.createElement("div", { className: "py-1" }, blocks.map((block, idx) => {
            ...
            return (React.createElement("div", { key: block.id, ref: el => { blockRefs.current[idx] = el; }, className: "px-3 py-1.5 border-b border-[#2a2a3e] last:border-b-0" },
                ...
                block.speaker && (React.createElement("div", { className: "text-[9px] text-blue-400 font-medium" }, block.speaker)),
                React.createElement("div", { className: "text-[10px] text-gray-300 line-clamp-1 bg-[#0d0d14] border border-[#2a2a3e] rounded px-2 py-1 mt-1" },
                    "\"",
