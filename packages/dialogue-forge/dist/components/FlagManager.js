...
function FlagManager({ flagSchema, dialogue, onUpdate, onClose }) {
    ...
    return (react_1.default.createElement("div", { className: "fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4", onClick: (e) => {
        ...
        react_1.default.createElement("div", { className: "bg-[#0d0d14] border border-[#1a1a2e] rounded-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col", onClick: (e) => e.stopPropagation() },
            react_1.default.createElement("div", { className: "p-4 border-b border-[#1a1a2e] flex items-center justify-between" },
                react_1.default.createElement("h2", { className: "text-lg font-semibold text-white" }, "Flag Manager"),
                react_1.default.createElement("div", { className: "flex gap-2" },
                    react_1.default.createElement("button", { onClick: () => handleCreateFlag(), className: "px-3 py-1.5 bg-[#e94560] hover:bg-[#d63850] text-white text-sm rounded flex items-center gap-2" },
            ...
            react_1.default.createElement("div", { className: "flex-1 overflow-y-auto p-4" }, editingFlag ? (react_1.default.createElement(FlagEditor, { flag: editingFlag, categories: flagSchema.categories || [], onSave: handleSaveFlag, onCancel: () => { setEditingFlag(null); setIsCreating(false); } })) : (react_1.default.createElement("div", { className: "space-y-4" },
                react_1.default.createElement("div", { className: "bg-[#12121a] border border-[#2a2a3e] rounded-lg p-4 text-sm" },
                    react_1.default.createElement("div", { className: "flex items-center justify-between mb-3" },
                        react_1.default.createElement("div", null,
                            react_1.default.createElement("p", { className: "text-gray-300 mb-2" },
                                react_1.default.createElement("strong", { className: "text-white" }, "Dialogue flags"),
                                " (gray) are temporary and reset after dialogue ends."),
                            react_1.default.createElement("p", { className: "text-gray-300" },
                                react_1.default.createElement("strong", { className: "text-white" }, "Game flags"),
                                " (colored) persist and affect the entire game.")),
                        react_1.default.createElement("div", { className: "text-right" },
                            react_1.default.createElement("div", { className: "text-2xl font-bold text-white" }, flagSchema.flags.length),
                            react_1.default.createElement("div", { className: "text-xs text-gray-500" }, "Total Flags"),
                            dialogue && (react_1.default.createElement("div", { className: "mt-2 pt-2 border-t border-[#2a2a3e]" },
                                react_1.default.createElement("div", { className: "text-sm" },
                                    ...
                                    react_1.default.createElement("span", { className: "text-xs text-gray-500 block mt-0.5" }, "Used in dialogue")))))),
                    react_1.default.createElement("div", { className: "grid grid-cols-7 gap-2 pt-3 border-t border-[#2a2a3e]" }, Object.entries(flagTypeLabels).map(([type, label]) => {
                        const count = flagSchema.flags.filter(f => f.type === type).length;
                        return (react_1.default.createElement("div", { key: type, className: "text-center" },
                            react_1.default.createElement("div", { className: `text-lg font-bold ${flagTypeColors[type].split(' ')[1]}` }, count),
                            react_1.default.createElement("div", { className: "text-[10px] text-gray-500 mt-0.5" }, label.split(' ')[0])));
                    }))),
                Object.entries(flagsByCategory).map(([category, flags]) => {
                    ...
                    return (react_1.default.createElement("div", { key: category, className: "border border-[#1a1a2e] rounded-lg overflow-hidden" },
                        react_1.default.createElement("div", { className: "bg-[#12121a] px-4 py-2 border-b border-[#1a1a2e] flex items-center justify-between" },
                            react_1.default.createElement("h3", { className: "text-sm font-semibold text-white uppercase" }, category),
                            react_1.default.createElement("button", { onClick: () => handleCreateFlag(categoryType, category), className: "p-1 text-gray-400 hover:text-white hover:bg-[#2a2a3e] rounded transition-colors", title: `Create new ${categoryType} flag` },
                                react_1.default.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" },
                                    react_1.default.createElement("line", { x1: "12", y1: "5", x2: "12", y2: "19" }),
                                    react_1.default.createElement("line", { x1: "5", y1: "12", x2: "19", y2: "12" })))),
                        react_1.default.createElement("div", { className: "divide-y divide-[#1a1a2e]" }, flags.map(flag => {
                            const isUsed = usedFlags.has(flag.id);
                            return (react_1.default.createElement("div", { key: flag.id, className: `bg-[#0d0d14] hover:bg-[#12121a] transition-colors ${isUsed ? 'border-l-2 border-[#e94560]' : ''}` },
                                react_1.default.createElement("div", { className: "px-4 py-3 flex items-center justify-between" },
                                    react_1.default.createElement("div", { className: "flex items-center gap-3 flex-1" },
                                        ...
                                        react_1.default.createElement("div", { className: "flex-1" },
                                            react_1.default.createElement("div", { className: "flex items-center gap-2" },
                                                ...
                                                isUsed && (react_1.default.createElement("span", { className: "text-[10px] px-1.5 py-0.5 bg-[#e94560]/20 text-[#e94560] rounded border border-[#e94560]/30", title: "Used in dialogue" }, "Used"))),
                                            flag.name !== flag.id && (react_1.default.createElement("div", { className: "text-xs text-gray-400" }, flag.name)),
                                            flag.description && (react_1.default.createElement("div", { className: "text-xs text-gray-500 mt-1" }, flag.description))),
                                        flag.valueType && (react_1.default.createElement("span", { className: "text-xs text-gray-500 px-2 py-1 bg-[#12121a] rounded" }, flag.valueType))),
                                    react_1.default.createElement("div", { className: "flex gap-1" },
                                        react_1.default.createElement("button", { onClick: () => setEditingFlag(flag), className: "p-1.5 text-gray-400 hover:text-white", title: "Edit" },
                                            react_1.default.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" },
                                        ...
                                        react_1.default.createElement("button", { onClick: () => handleDeleteFlag(flag.id), className: "p-1.5 text-gray-400 hover:text-red-400", title: "Delete" },
                                            react_1.default.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2" },
                ...
                flagSchema.flags.length === 0 && (react_1.default.createElement("div", { className: "text-center py-12 text-gray-500" },
                    react_1.default.createElement("p", null, "No flags defined yet."),
                    react_1.default.createElement("button", { onClick: () => handleCreateFlag(), className: "mt-4 px-4 py-2 bg-[#e94560] hover:bg-[#d63850] text-white rounded" }, "Create Your First Flag")))))))));
}
