/**
 * Next typecheck follows repo-planner sources into `./planning-parse-core.mjs` and may not
 * attach `planning-parse-core.mjs.d.ts`. Declare the module by stable package subpath.
 */
declare module 'repo-planner/lib/planning-parse-core.mjs' {
