...
const catalog: ListenCatalogEntry[] = [
  ...
  },
  {
    ...
    genre: 'Private track',
    duration: 'Private',
    mood: 'Locked, preview-only',
    era: 'Shared-key preview',
    description:
      'A real private BandLab revision surfaced as a gated listen row. It should only open after the shared group password is entered.',
    bandlabUrl:
