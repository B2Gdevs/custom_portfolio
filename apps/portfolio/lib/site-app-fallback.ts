...
export const FALLBACK_SITE_APPS: SiteAppRecord[] = [
  ...
  },
  {
    ...
    description:
      'Public reference site on Vercel — methodology, eval runs, playable demos, and install paths for the `gad` CLI. This monorepo still uses snapshot + planning files daily; the hosted site is the outward-facing front door.',
    ...
    supportText: 'Session start in-repo: `gad snapshot --projectid <id>` per AGENTS.md.',
    featuredOrder: 17,
  },
  {
    id: 'repo-planner',
    title: 'Repo Planner',
    description:
      'Archived reference landing on Vercel — embedded cockpit demo, built-in planning packs, and XML planning templates. New work lives under GAD; this site stays useful as a read-only preview of the old embed.',
    href: 'https://repo-planner.vercel.app/',
    iconName: 'layers',
    cta: 'Open Repo Planner on Vercel',
    supportHref: '/docs/repo-planner/planning/planning-docs',
    supportLabel: 'Repo Planner docs on this site',
    supportText: 'Local redirect from `/apps/repo-planner` points at GAD planning state; the Vercel app is the iframe-style demo.',
    featuredOrder: 18,
  },
  {
    id: 'planning-pack',
