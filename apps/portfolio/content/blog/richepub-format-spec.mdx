...
RichEPub (`.repub`) is a **ZIP-based container** with a fixed layout and a root manifest. Full documentation lives in the [docs](/docs/richepub/format-spec); this post summarizes the main ideas.
...
For the full schema and examples, see the [RichEPub format spec](/docs/richepub/format-spec) in the docs.
