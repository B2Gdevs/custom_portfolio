...
- [Books Planning Docs](/docs/books/planning-docs) for the books, reader, and publishing roadmap.
...
IA, content order, and visual direction live in section planning pages (e.g. [books](/docs/books/planning-docs)). **Monorepo-wide** scope is in [Documentation — Requirements](/docs/documentation/requirements); the **XML loop** is under **`.planning/`** — see root **`AGENTS.md`**.
</Callout>
...
<DocLinkCard href="/docs/books/state" title="Books section state" description="Current cycle, focus, and next queue for the books pipeline." />
<DocLinkCard href="/docs/books/planning-docs" title="Books planning docs" description="Planning docs index for the books section." />

---

## How this repo is structured

The repo is a **monorepo** with a clear place for “what we’re building and why.” **As of March 2026**, agents start at repo-root **`AGENTS.md`**; **monorepo-wide** narrative and cross-cutting queue live in the **Documentation** section ([requirements](/docs/documentation/requirements), [state](/docs/documentation/state)), and **`.planning/`** holds the **RepoPlanner XML** loop (`ROADMAP.xml`, `TASK-REGISTRY.xml`, `STATE.xml`, …). Repo-root **`REQUIREMENTS.md`** is a **stub pointer** — not where long-form scope is edited anymore.
...
- **`documentation/state.mdx`** — **Cross-cutting queue** and documentation-section cycle.
...
- **Per-section** planning — Each `docs/<section>/` has **`planning-docs.mdx` → `state.mdx` → `task-registry.mdx` → `decisions.mdx`** (e.g. [books planning](/docs/books/planning-docs)).
...
<DocLinkCard href="/docs/documentation/state" title="Documentation — State" description="Cross-cutting queue and docs-section cycle." />
...
<DocLinkCard href="/docs/books/decisions" title="Books decisions" description="Record of key decisions for the books pipeline and reader." />
<DocLinkCard href="/docs/books/task-registry" title="Books task registry" description="Task registry for the books section." />
