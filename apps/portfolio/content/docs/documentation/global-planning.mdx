...
| `stream` | Product line inside that section (e.g. `reader`, `publishing`, `site` for the docs site itself, `workflow` for the editor toolchain). Prefer stable stream names over one-off topics. |
