...
This page complements [Route conventions](/docs/documentation/route-conventions), [Repo Planner — Integration](/docs/repo-planner/integration), and [books task registry](/docs/books/task-registry) phase **`books-reader-03`**.
...
5. **Docs** — extend file-tree context menu with “Open in planning cockpit” → build payload from `folderArchivePrefix` / section path; document payload contract here and in [integration](/docs/repo-planner/integration).
