...
Same `books/<slug>/` source → **EPUB** (HTML, base64 images) and readable surfaces on the site. One requirements doc ([`.planning/REQUIREMENTS.md`](../../../../../.planning/REQUIREMENTS.md)) and this design doc keep the intent clear.
