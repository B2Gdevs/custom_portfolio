...
| Id | Status | Goal | Depends | Verify |
| --- | --- | --- | --- | --- |
| `mt-act2-00` | `planned` | lock Act II chapter list + beat map (chapter boundaries, POV owner, scene purpose per chapter) | `mt-act1-03` | state roadmap (Act II) + decisions aligned |
...
| Id | Status | Goal | Depends | Verify |
| --- | --- | --- | --- | --- |
| `mt-act3-00` | `planned` | lock Act III chapter list + beat map (battle chapter, carriage/reveal chapter, throne-take chapter) | `mt-act2-01` | state roadmap (Act III) + decisions aligned |
