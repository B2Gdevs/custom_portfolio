...
| `books-01-12` | `in-progress` | add a subtle bottom navigation strip with current section title, previous/next controls, and direct page jumps on the dedicated reader | `books-01-11` | `pnpm run build`, `pnpm run lint` |
| `books-01-13` | `planned` | expand planning records around publishing, editions, and progression | `books-01-12` | `pnpm run build:books` |
| `books-01-14` | `planned` | build a live EPUB for the next visible book once the manuscript is ready | `books-01-12` | `pnpm run build:books`, `pnpm run build` |
