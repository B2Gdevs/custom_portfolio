...
The public embed is **read-only on the server** (**GET** bundle; **POST** apply/CLI **403** unless explicitly enabled). Cockpit UI is allowed; operators export and commit from git. See [Repo Planner -- Decisions](/docs/repo-planner/decisions) **`REPOPLAN-EMBED-01`**.
</details>
