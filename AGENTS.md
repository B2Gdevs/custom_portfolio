...
5. **Operators / RepoPlanner CLI:** **[repo-planner/planning-docs.mdx](apps/portfolio/content/docs/repo-planner/planning-docs.mdx)**, **[repo-planner/getting-started.mdx](apps/portfolio/content/docs/repo-planner/getting-started.mdx)**, and **[repo-planner/decisions.mdx](apps/portfolio/content/docs/repo-planner/decisions.mdx)**.
...
3. Run **verification**; mark **`done`** in **`TASK-REGISTRY.xml`** and/or the relevant section `task-registry.mdx`; refresh **`.planning/STATE.xml`** when it helps the next agent; update **`documentation/requirements.mdx`**, **`documentation/state.mdx`**, or the relevant **roadmap** when monorepo scope or queue priority changes.
