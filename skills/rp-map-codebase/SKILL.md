...
description: Map an existing codebase to planning docs. Deprecated RepoPlanner alias — canonical methodology is under get-anything-done/skills/.
---

# rp-map-codebase → GAD (deprecated stub)
...
**Canonical skill:** `../../vendor/get-anything-done/skills/map-codebase/SKILL.md`
