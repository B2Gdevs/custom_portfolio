---
name: gad:add-todo
description: Capture a follow-up into planning todos. Deprecated RepoPlanner alias — canonical methodology is under get-anything-done/skills/.
---

# rp-add-todo → GAD (deprecated stub)
...
**Canonical skill:** `../../vendor/get-anything-done/skills/add-todo/SKILL.md`
