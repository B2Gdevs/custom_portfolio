---
name: gad:plan-phase
description: Plan a phase (KICKOFF + PLAN). Deprecated RepoPlanner alias — canonical methodology is under get-anything-done/skills/.
---

# rp-plan-phase → GAD (deprecated stub)
...
**Canonical skill:** `../../vendor/get-anything-done/skills/plan-phase/SKILL.md`
