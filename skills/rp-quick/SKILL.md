---
name: gad:quick
description: Small ad-hoc task with planning guarantees. Deprecated RepoPlanner alias — canonical methodology is under get-anything-done/skills/.
---

# rp-quick → GAD (deprecated stub)
...
**Canonical skill:** `../../vendor/get-anything-done/skills/quick/SKILL.md`
