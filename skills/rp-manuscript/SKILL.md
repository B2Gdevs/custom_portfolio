---
name: gad:manuscript
description: Fiction / manuscript planning loop. Deprecated RepoPlanner alias — canonical methodology is under get-anything-done/skills/.
---

# rp-manuscript → GAD (deprecated stub)
...
**Canonical skill:** `../../vendor/get-anything-done/skills/manuscript/SKILL.md`
